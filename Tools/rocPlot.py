...
#files =  ["RF_Test_1/roc.pkl",    "RF_Test_2/roc.pkl", "roc.pkl"]
#labels = ["RF Old",      "RF New", "RF Old Correct"]

files =  ["roc_rf_nominal.pkl", "roc_rf_csvSort_dRPt_n2.pkl", "roc_rf_TeamAVars.pkl"]#, "roc_mlp_TeamAVars.pkl", "roc_mlp_nominal.pkl"]
labels = ["RF Nominal",         "RF CSV Sort + dRPt + n2",    "RF Team A vars"]#,       "MLP Team A vars",       "MLP Nominal"]
