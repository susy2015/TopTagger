...
namespace ttUtility
{
    ...
    public:
        ...
        ConstAK8Inputs(const std::vector<TLorentzVector>& jetsLVec, const std::vector<FLOATTYPE>& deepAK8Top, const std::vector<FLOATTYPE>& softDropMass, const std::vector<std::vector<TLorentzVector> >& vecSubJetsLVec) : ConstGenInputs(), jetsLVec_(&jetsLVec), tau1_(nullptr), tau2_(nullptr), tau3_(nullptr), deepAK8Top_(&deepAK8Top), softDropMass_(&softDropMass), subjetsBtag_(nullptr), subjetsMult_(nullptr), subjetsPtD_(nullptr), subjetsAxis1_(nullptr), subjetsAxis2_(nullptr), subjetsLVec_(nullptr), vecSubjetsLVec_(&vecSubJetsLVec), vecSubjetsBtag_(nullptr), vecSubjetsMult_(nullptr), vecSubjetsPtD_(nullptr), vecSubjetsAxis1_(nullptr), vecSubjetsAxis2_(nullptr), puppisd_corrGEN_(nullptr), puppisd_corrRECO_cen_(nullptr), puppisd_corrRECO_for_(nullptr) { }

        ConstAK8Inputs(const std::vector<TLorentzVector>& jetsLVec, const std::vector<FLOATTYPE>& tau1, const std::vector<FLOATTYPE>& tau2, const std::vector<FLOATTYPE>& tau3, const std::vector<FLOATTYPE>& softDropMass, const std::vector<TLorentzVector>& subjetsLVec, const std::vector<TLorentzVector>& hadGenTops, const std::vector<std::vector<const TLorentzVector*>>& hadGenTopDaughters) : ConstGenInputs(hadGenTops, hadGenTopDaughters), jetsLVec_(&jetsLVec), tau1_(&tau1), tau2_(&tau2), tau3_(&tau3), deepAK8Top_(nullptr), softDropMass_(&softDropMass), subjetsBtag_(nullptr), subjetsMult_(nullptr), subjetsPtD_(nullptr), subjetsAxis1_(nullptr), subjetsAxis2_(nullptr), subjetsLVec_(&subjetsLVec), vecSubjetsLVec_(nullptr), vecSubjetsBtag_(nullptr), vecSubjetsMult_(nullptr), vecSubjetsPtD_(nullptr), vecSubjetsAxis1_(nullptr), vecSubjetsAxis2_(nullptr), puppisd_corrGEN_(nullptr), puppisd_corrRECO_cen_(nullptr), puppisd_corrRECO_for_(nullptr) { }

        ConstAK8Inputs(const std::vector<TLorentzVector>& jetsLVec, const std::vector<FLOATTYPE>& deepAK8Top, const std::vector<FLOATTYPE>& softDropMass, const std::vector<TLorentzVector>& subjetsLVec, const std::vector<TLorentzVector>& hadGenTops, const std::vector<std::vector<const TLorentzVector*>>& hadGenTopDaughters) : ConstGenInputs(hadGenTops, hadGenTopDaughters), jetsLVec_(&jetsLVec), tau1_(nullptr), tau2_(nullptr), tau3_(nullptr), deepAK8Top_(&deepAK8Top), softDropMass_(&softDropMass), subjetsBtag_(nullptr), subjetsMult_(nullptr), subjetsPtD_(nullptr), subjetsAxis1_(nullptr), subjetsAxis2_(nullptr), subjetsLVec_(&subjetsLVec), vecSubjetsLVec_(nullptr), vecSubjetsBtag_(nullptr), vecSubjetsMult_(nullptr), vecSubjetsPtD_(nullptr), vecSubjetsAxis1_(nullptr), vecSubjetsAxis2_(nullptr), puppisd_corrGEN_(nullptr), puppisd_corrRECO_cen_(nullptr), puppisd_corrRECO_for_(nullptr) { }

        ConstAK8Inputs(const std::vector<TLorentzVector>& jetsLVec, const std::vector<FLOATTYPE>& tau1, const std::vector<FLOATTYPE>& tau2, const std::vector<FLOATTYPE>& tau3, const std::vector<FLOATTYPE>& softDropMass, const std::vector<TLorentzVector>& subjetsLVec, const std::vector<FLOATTYPE>& subjetsBtag, const std::vector<FLOATTYPE>& subjetsMult, const std::vector<FLOATTYPE>& subjetsPtD, const std::vector<FLOATTYPE>& subjetsAxis1, const std::vector<FLOATTYPE>& subjetsAxis2, const std::vector<TLorentzVector>& hadGenTops, const std::vector<std::vector<const TLorentzVector*>>& hadGenTopDaughters) : ConstGenInputs(hadGenTops, hadGenTopDaughters), jetsLVec_(&jetsLVec), tau1_(&tau1), tau2_(&tau2), tau3_(&tau3), deepAK8Top_(nullptr), softDropMass_(&softDropMass), subjetsBtag_(&subjetsBtag), subjetsMult_(&subjetsMult), subjetsPtD_(&subjetsPtD), subjetsAxis1_(&subjetsAxis1), subjetsAxis2_(&subjetsAxis2), subjetsLVec_(&subjetsLVec), vecSubjetsLVec_(nullptr), vecSubjetsBtag_(nullptr), vecSubjetsMult_(nullptr), vecSubjetsPtD_(nullptr), vecSubjetsAxis1_(nullptr), vecSubjetsAxis2_(nullptr), puppisd_corrGEN_(nullptr), puppisd_corrRECO_cen_(nullptr), puppisd_corrRECO_for_(nullptr) { }
        ...
        ConstAK8Inputs(const std::vector<TLorentzVector>& jetsLVec, const std::vector<FLOATTYPE>& deepAK8Top, const std::vector<FLOATTYPE>& softDropMass, const std::vector<std::vector<TLorentzVector> >& vecSubJetsLVec, const std::vector<TLorentzVector>& hadGenTops, const std::vector<std::vector<const TLorentzVector*>>& hadGenTopDaughters) : ConstGenInputs(hadGenTops, hadGenTopDaughters), jetsLVec_(&jetsLVec), tau1_(nullptr), tau2_(nullptr), tau3_(nullptr), deepAK8Top_(&deepAK8Top), softDropMass_(&softDropMass), subjetsBtag_(nullptr), subjetsMult_(nullptr), subjetsPtD_(nullptr), subjetsAxis1_(nullptr), subjetsAxis2_(nullptr), subjetsLVec_(nullptr), vecSubjetsLVec_(&vecSubJetsLVec), vecSubjetsBtag_(nullptr), vecSubjetsMult_(nullptr), vecSubjetsPtD_(nullptr), vecSubjetsAxis1_(nullptr), vecSubjetsAxis2_(nullptr), puppisd_corrGEN_(nullptr), puppisd_corrRECO_cen_(nullptr), puppisd_corrRECO_for_(nullptr) { }
