...
Construct an A\-K4 jet from T\-Lorentz\-Vector, b-\/tag discriminator, and quark-\/gluonlikelihood \hypertarget{classConstituent_aed3114a0fd1fdbd1d19ff1117ca9388e}{\index{Constituent@{Constituent}!Constituent@{Constituent}}
\index{Constituent@{Constituent}!Constituent@{Constituent}}
\subsubsection[{Constituent}]{\setlength{\rightskip}{0pt plus 5cm}Constituent\-::\-Constituent (
\begin{DoxyParamCaption}
\item[{const T\-Lorentz\-Vector \&}]{p, }
\item[{const Constituent\-::\-Constituent\-Type \&}]{type}
\end{DoxyParamCaption}
)}}\label{classConstituent_aed3114a0fd1fdbd1d19ff1117ca9388e}
...
\end{DoxyReturn}
\hypertarget{classConstituent_aaa1bb377b75859b50c40feb217c98cb9}{\index{Constituent@{Constituent}!get\-Jet\-Ref\-Indicies@{get\-Jet\-Ref\-Indicies}}
\index{get\-Jet\-Ref\-Indicies@{get\-Jet\-Ref\-Indicies}!Constituent@{Constituent}}
\subsubsection[{get\-Jet\-Ref\-Indicies}]{\setlength{\rightskip}{0pt plus 5cm}const std\-::vector$<$ int $>$ \& Constituent\-::get\-Jet\-Ref\-Indicies (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}\label{classConstituent_aaa1bb377b75859b50c40feb217c98cb9}
Retrieve list of jet index references \begin{DoxyReturn}{Returns}
Vector containing jet reference indices 
\end{DoxyReturn}
